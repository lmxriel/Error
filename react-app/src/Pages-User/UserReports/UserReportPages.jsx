      ...
      <div className="flex flex-col md:flex-row w-full h-screen bg-dashboard-bg">
        ...
        <div className="flex-1 w-full h-auto p-5 transition-all duration-300 ease-in-out">
          <div className="flex flex-col items-center md:flex-row gap-5 border-b-2 border-b-black pb-5">
            <img className="w-24 h-24 md:w-32 md:h-32 rounded-full" />
            ...
            <table className="min-w-full bg-white border border-gray-300">
              <thead>
                <tr>
                  ...
                  <th className="py-2 px-4 border-b">Work Duration</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="py-2 px-4 border-b">1</td>
                  <td className="py-2 px-4 border-b">Juan Dela Cruz</td>
                  <td className="py-2 px-4 border-b">2024-08-31</td>
                  <td className="py-2 px-4 border-b">10:50 AM</td>
                  <td className="py-2 px-4 border-b">5:00 PM</td>
                  <td className="py-2 px-4 border-b">6 hours 10 minutes</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border-b">2</td>
                  <td className="py-2 px-4 border-b">Juan Dela Cruz</td>
                  <td className="py-2 px-4 border-b">2024-09-31</td>
                  <td className="py-2 px-4 border-b">11:00 AM</td>
                ...
                <tr>
                  ...
                  <td className="py-2 px-4 border-b">Juan Dela Cruz</td>
                  <td className="py-2 px-4 border-b">2024-10-31</td>
                  <td className="py-2 px-4 border-b">10:50 AM</td>
                  <td className="py-2 px-4 border-b">5:00 PM</td>
                  <td className="py-2 px-4 border-b">6 hours 10 minutes</td>
                </tr>
