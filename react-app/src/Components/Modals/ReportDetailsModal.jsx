...
function ReportDetailsModal({ isOpen, onClose, ReportDetails }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div
        ref={modalRef}
        className="w-full max-w-6xl h-[60vh] max-h-[60vh] p-6 rounded-lg shadow-lg relative bg-gradient-to-br from-green-700 to-green-600 flex flex-col"
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto bg-white rounded-lg shadow max-h-[40vh] w-full">
          <table className="w-full table-auto divide-y divide-gray-200">
            <thead className="bg-green-700 text-white">
              <tr>
                ...
                <th className="py-3 px-4">Time Start</th>
                <th className="py-3 px-4">Time End</th>
